                ...
                {messages.map((message, index) => (
                    <div key={index} className="flex w-full">
                        {message.by === "agent" ? (
                            <>
                                <div
                                    className="max-w-[80%] bg-card py-3 px-5 rounded-2xl border-2 border-border rounded-bl-none leading-7 shadow-primary/10 shadow-lg">
                            ...
                            <>
                                ...
                                {/* spacer */}
                                <div
                                    className="max-w-[80%] bg-secondary py-3 px-5 rounded-2xl border-2 border-border rounded-br-none leading-7 shadow-primary/10 shadow-lg">
                                    <MyMarkdown>{message.message}</MyMarkdown>
                                </div>
                            </>
                        )}
